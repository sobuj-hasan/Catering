                ...
                <div class="col-xl-4 col-lg-4 col-md-12 col-sm-12">
                    ...
                    <div class="d-flex more-blog my-3">
                        ...
                        <div class="flex-grow-1 ms-3">
                            <a href="#">
                                <p class="title">Lorem Ipsum generators on Internet tend..</p>
                            </a>
                            <p class="paragraph">Lorem Ipsum generators on the Internet tend to repeat...</p>
                        </div>
                    </div>
                    <div class="d-flex more-blog my-3">
                        <div class="flex-shrink-0">
