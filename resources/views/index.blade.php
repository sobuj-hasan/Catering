...
@section('body')
    ...
    <section class="special-catering">
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center mb-sm-3 mb-lg-5">
                    <h4>Choose Your</h4>
                    <h2 class="section-header">Special catering Goods</h2>
                    <ul class="d-flex justify-content-center">
                        <li>
                            <a class="active" href="#">Brackfast</a>
        ...
        <div class="container">
            ...
            <div class="row pb-lg-5">
                <div class="col-xl-5 col-lg-5 col-md-12 col-sm-12">
                    ...
                    <p class="paragraph">Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the
                        industry's standard
                    ...
                    <div class="blog-info mt-5 d-flex">
                        ...
                        <div class="right">
                            <i class="far fa-comment"></i> <span class="ms-lg-1"> 123</span>
                            <i class="fas fa-share-alt ms-lg-2"></i> <span class="ms-lg-1"> 08</span>
                        </div>
                    </div>
                </div>
                <div class="col-xl-7 col-lg-7 col-md-12 col-sm-12">
                    <div class="d-flex blog mb-4">
                        <img src="assets/img/blog/blog1.png" alt="blog-img">
                    ...
                    <div class="d-flex blog mb-4">
                        <img src="assets/img/blog/blog2.png" alt="blog-img">
                        <div class="flex-grow-1 ms-3 align-self-center content">
                    ...
                    <div class="d-flex blog mb-4">
                        <img src="assets/img/blog/blog3.png" alt="blog-img">
                        <div class="flex-grow-1 ms-3 align-self-center content">
