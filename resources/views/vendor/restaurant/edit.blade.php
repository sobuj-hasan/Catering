        ...
        <div class="row mt-4">
            <div class="col-md-12 m-auto">
                <div class="card-box">
                    ...
                    <form method="POST" action="{{ route('vendorrestaurant.update', $single_restaurant->id) }}" class="form-horizontal" role="form" enctype="multipart/form-data">
                        @csrf
                        @method('PATCH')
                            ...
                            <div class="col-9">
                                <div class="fileupload fileupload-new" data-provides="fileupload">
                                    <div class="fileupload-new thumbnail" style="width: 200px; height: 150px;">
                                        <img src="{{ asset('assets/img/restaurant/') }}/{{ $single_restaurant->res_image }}" alt="image" />
                                    </div>
